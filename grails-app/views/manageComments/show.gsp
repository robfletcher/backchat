            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.document.label" default="Document" /></td>
                            
                            <td valign="top" class="value"><g:link controller="document" action="show" id="${commentInstance?.document?.id}">${commentInstance?.document?.encodeAsHTML()}</g:link></td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="comment.nickname.label" default="Nickname" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: commentInstance, field: "nickname")}</td>
